...
{
    public partial class Form_ThiTracNghiem : Form
    {
        private Form_MainForm_SV mainForm_SV;
        private DTO_SinhVien sv;
        private DTO_DeThi de;
        private DTO_BaiThi baiThi;
        private int count=0;
        List<DTO_CauHoi> DSCauHoi;
        public Form_ThiTracNghiem(Form_MainForm_SV mainForm_SV, string maSV)
        {
            InitializeComponent();
        ...
        private void btnNopBai_Click(object sender, EventArgs e)
        {
            ...
            if(lamXong)
            {
            Form_NopBai nopbai = new Form_NopBai(baiThi,de);
            nopbai.Show();
            this.Hide();
            }
        }
